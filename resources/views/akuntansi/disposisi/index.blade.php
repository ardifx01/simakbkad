@extends('akuntansi.template')

@section('content')
<div class="col-lg-10 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Disposisi Masuk untuk Bidang Akuntansi</h4>
            <p class="card-description">List disposisi yang ditujukan ke bidang Akuntasi</p>
                    ...
                    <tbody>
                        @foreach ($disposisis as $index => $disposisi)
                            <tr class="clickable-row" 
                                data-href="{{ route('akuntansi.disposisi.detail', $disposisi->id) }}"
