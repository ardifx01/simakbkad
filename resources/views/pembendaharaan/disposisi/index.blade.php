...
<div class="col-lg-10 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Disposisi Masuk untuk Bidang Pembendaharaan</h4>
            <p class="card-description">List disposisi yang ditujukan ke bidang Pembendaharaan</p>
                    ...
                    <tbody>
                        @foreach ($disposisis as $index => $disposisi)
                            <tr class="clickable-row" 
                                data-href="{{ route('pembendaharaan.disposisi.detail', $disposisi->id) }}"
